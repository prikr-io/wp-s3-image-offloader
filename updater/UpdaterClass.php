...
if (!class_exists('prikrUpdateChecker')) {
    ...
    class prikrUpdateChecker
    {
        ...
        public function __construct()
        {
            ...
            $this->version = $this->resolvePluginVersion($this->plugin_basefile);
        ...
        /**
         * Determine the current plugin version from the main plugin header.
         */
        private function resolvePluginVersion($relativePluginFile)
        {
            $pluginFile = WP_PLUGIN_DIR . '/' . ltrim($relativePluginFile, '/');
            ...
            if (file_exists($pluginFile)) {
                $pluginData = get_file_data($pluginFile, ['Version' => 'Version'], false);
