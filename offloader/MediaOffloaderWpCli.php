...
if (defined('WP_CLI') && WP_CLI) {
    ...
    WP_CLI::add_command(
        WPS3_CLI_COMMAND . ' offload-images',
        function ($args, $assoc_args) {
            $s3MediaOffloaderCLI = new s3MediaOffloaderCLI();
            $s3MediaOffloaderCLI->list_missing_images($args, $assoc_args);
        },
        [
            'shortdesc' => 'Offload all images to S3.'
        ]
    );
    ...
    WP_CLI::add_command(
        ...
        function ($args, $assoc_args) {
            $s3MediaOffloaderCLI = new s3MediaOffloaderCLI();
            $s3MediaOffloaderCLI->delete_postmeta($args, $assoc_args);
        },
        [
