...
<?php }
  ...
  public function wps3_image_offloader_page_init()
  {
    ...
    add_settings_field(
      'wps3_enable_lqip', // id
      'Blurred placeholders', // title
      array($this, 'wps3_enable_lqip_callback'), // callback
      'wps3-image-offloader-admin', // page
      'wps3_image_offloader_setting_section' // section
    );

    add_settings_field(
      'wps3_enable_lqip_transition', // id
      'Soft transition', // title
      array($this, 'wps3_enable_lqip_transition_callback'), // callback
      'wps3-image-offloader-admin', // page
      'wps3_image_offloader_setting_section' // section
    );
  ...
  public function wps3_image_offloader_sanitize($input)
  {
    ...
    if (isset($input['wps3_enable_lqip'])) {
      $sanitary_values['wps3_enable_lqip'] = $input['wps3_enable_lqip'];
    }

    if (isset($input['wps3_enable_lqip_transition'])) {
      $sanitary_values['wps3_enable_lqip_transition'] = $input['wps3_enable_lqip_transition'];
    }
  ...
  public function wps3_enable_lqip_callback()
  {
    printf(
      '<input type="checkbox" name="wps3_image_offloader[wps3_enable_lqip]" id="wps3_enable_lqip" value="wps3_enable_lqip" %s> <label for="wps3_enable_lqip">Show a blurred low-resolution placeholder until the high-quality image is ready.</label>',
      (isset($this->wps3_image_offloader_options['wps3_enable_lqip']) && $this->wps3_image_offloader_options['wps3_enable_lqip'] === 'wps3_enable_lqip') ? 'checked' : ''
    );
  }

  public function wps3_enable_lqip_transition_callback()
  {
    printf(
      '<input type="checkbox" name="wps3_image_offloader[wps3_enable_lqip_transition]" id="wps3_enable_lqip_transition" value="wps3_enable_lqip_transition" %s> <label for="wps3_enable_lqip_transition">Add a gentle fade/blur transition when swapping the placeholder for the final image.</label>',
      (isset($this->wps3_image_offloader_options['wps3_enable_lqip_transition']) && $this->wps3_image_offloader_options['wps3_enable_lqip_transition'] === 'wps3_enable_lqip_transition') ? 'checked' : ''
    );
  }
